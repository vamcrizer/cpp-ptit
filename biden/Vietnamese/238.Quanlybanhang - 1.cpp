...
class HoaDon{
	public:
		...
		friend ostream& operator << (ostream &out, HoaDon a){
			cout << a.paper_id << " " << mp1[a.customer_id].name << " " << mp1[a.customer_id].address << " " << mp2[a.item_id].item_name << " " << mp2[a.item_id].item_unit << " " << mp2[a.item_id].item_buy << " " << mp2[a.item_id].item_sell << " " << a.quantity << " ";
			cout << 1ll * mp2[a.item_id].item_sell * a.quantity << endl;
			return out;
		}
		// Biden
};
